...
public:
	...
	StellarState();
	StellarState(const Vector<Real, STATE_NF>&);
	~StellarState() {
		return;
	}
	...
	StellarState& operator=(const StellarState& s) {
		this->Vector<Real, STATE_NF>::operator=(s);
		return *this;
	}
	StellarState& operator=(const Vector<Real, STATE_NF>& s) {
		this->Vector<Real, STATE_NF>::operator=(s);
		return *this;
	}
	StellarState(const StellarState& s) {
		*this = s;
	}
